...
export default function ProjectCard({ project }: ProjectCardProps) {
  return (
    <div>
      ...
      <Dialog.Root>
        <Dialog.Trigger>
          <div className="flex h-full max-h-[305px] w-full max-w-[370px] flex-col overflow-hidden rounded-lg border-2 border-slate-500 dark:border-lines">
            <div className="min-h-36 w-full overflow-hidden">
              <Image alt="" src={project.imageUrl} width={386} height={145} />
            </div>
            <div className="flex min-h-[180px] w-full flex-col justify-between gap-2 bg-slate-400 px-7 py-5  dark:bg-primary-dark-blue">
